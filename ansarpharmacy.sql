...
(41, 'Hamza Ibrahim Danasabe', '08037856962', 'hamxah4u@gmail.com', '$2y$10$8pEI2FXeGTN38dW3ze2C3OUXcaxcA4lgF/m.1qW1euAwL8TVec9wK', 'No10 Sheikh dahiru Street Bauchi, Bauchi State', 'hamxah4u@gmail.com', '2025-12-23 16:38:22'),
(42, 'Musa Sani', '12345', '', '$2y$10$i7eP9IQzPKeth3yWvOFBkueYI9Vlzi1z1hGKt3C1a9.UNeCABY/0C', 'Fadan Bayak', 'hamxah4u@gmail.com', '2026-01-04 13:30:42'),
(43, 'Usman Abubakar', '89436738', '', '$2y$10$5rrRLPZ2GfRee6s0W6SFLeDGpA00ZdfPPd2xkMn01hV99K930ItB.', 'Kobi', 'hamxah4u@gmail.com', '2026-01-12 16:37:23');
...
--
-- Table structure for table `diary_tbl`
--
...
CREATE TABLE `diary_tbl` (
  ...
  `datercorded` date NOT NULL DEFAULT current_timestamp(),
  `timerecorded` time NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `diary_tbl`
--

INSERT INTO `diary_tbl` (`id`, `user_id`, `subject`, `message`, `datercorded`, `timerecorded`) VALUES
...
(19, 11, 'sssss', 'fggg', '2025-12-23', '18:06:57'),
...
(67, 'GD', 333.00, '422', 'hamxah4u@gmail.com', '2025-12-02 15:15:48', '2025-12-02 15:15:48'),
(68, '323', 12000.00, 'k', 'hamxah4u@gmail.com', '2025-12-23 16:39:40', '2025-12-23 16:39:40'),
(69, 'jj', 222222.00, 'bb', 'hamxah4u@gmail.com', '2026-01-28 19:54:05', '2026-01-28 19:54:05'),
(70, 'Driver', 100000.00, 'Jos juwa bauchi', 'hamxah4u@gmail.com', '2026-02-07 21:08:04', '2026-02-07 21:08:04'),
(71, 'Madaki', 10000.00, 'Addua', 'hamxah4u@gmail.com', '2026-02-07 21:08:46', '2026-02-07 21:08:46'),
(72, 'Madaki', 15000.00, 'Yan waju', 'hamxah4u@gmail.com', '2026-02-07 21:09:18', '2026-02-07 21:09:18');
...
CREATE TABLE `supply_tbl` (
  ...
  `productcode` varchar(254) DEFAULT NULL,
...
--
ALTER TABLE `department_tbl`
  MODIFY `deptID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `diary_tbl`
--
ALTER TABLE `diary_tbl`
