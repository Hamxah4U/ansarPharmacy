...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(empty($errors)){
        ...
        $stmt = $db->conn->prepare("INSERT INTO transaction_tbl (tCode, tDepartment, Product, Price, qty, Amount, Customer, TrasacBy, nhisno, TransacTime, TransacDate, pprice, Status)
         VALUES(:tcode, :tdpt, :product, :price, :qty, :amount, :customer, :TrasacBy, :nhisno, CURRENT_TIME(), CURDATE(), :pprice, 'Not-Paid')");
