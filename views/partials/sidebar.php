...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item active">
    <a class="nav-link" href="/inventory-reconciliation" id="compareStockBtn">
      <i class="fas fa-balance-scale"></i>
      <strong>Inventory Rec.</strong>
    </a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="javascript:void(0);" data-toggle="collapse" data-target="#collapseCreditors"
...
$(document).ready(function() {
  // Prevent any collapse toggle link from appending '#' to the URL
